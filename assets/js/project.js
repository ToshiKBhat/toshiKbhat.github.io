...
const projects = [
  ...
  {
    title: "TCP Packet Exchange Simulation",
    ...
    },
  {
    ...
    description: "Multiple well documented Hadoop programs as part of a big data course.",
    tagimg: "https://cdn.iconscout.com/icon/free/png-512/react-1-282599.png",
    Previewlink: "",
    Githublink: "",
  },
...

  {
    ...
    description: "A python program to simulate the National Resident matching program using applicant proposing algorithm with test module.",
    tagimg:
